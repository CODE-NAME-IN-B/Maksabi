...
class AddSalesScreen extends ConsumerStatefulWidget {
  ...
  const AddSalesScreen({super.key, this.existing});
...
class _AddSalesScreenState extends ConsumerState<AddSalesScreen> {
  ...
  void initState() {
    ...
    _selectedPeriod = widget.existing != null
        ? PeriodType.values[widget.existing!.period.index]
        : PeriodType.day;
  }
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (widget.existing != null) {
        ...
        await service.updateSales(updated);
      } else {
        await service.addSales(
          date: _selectedDate,
          amount: amount,
          period: _selectedPeriod,
          note: note.isEmpty ? null : note,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.existing != null ? 'تعديل المبيعات' : 'تسجيل مبيعات'),
        leading: IconButton(
          ...
          child: ConstrainedBox(
            ...
            child: Form(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.trending_up, color: AppColors.primaryLight, size: 32),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(hintText: 'مثال: مبيعات نهاية الأسبوع، طلبية كبيرة...'),
              ),
              const SizedBox(height: AppSpacing.lg),
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(widget.existing != null ? 'حفظ التعديلات' : 'تسجيل المبيعات'),
