...
class AddCapitalScreen extends ConsumerStatefulWidget {
  final CapitalEntry? existing;

  const AddCapitalScreen({super.key, this.existing});

  @override
  ConsumerState<AddCapitalScreen> createState() => _AddCapitalScreenState();
}

class _AddCapitalScreenState extends ConsumerState<AddCapitalScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (widget.existing != null) {
        final updated = CapitalEntry(
          id: widget.existing!.id,
          date: _selectedDate,
          amount: amount,
          note: note.isEmpty ? null : note,
        );
        await service.updateCapital(updated);
      } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.existing != null ? 'تعديل رأس المال' : 'إضافة رأس مال'),
        leading: IconButton(
          ...
          child: ConstrainedBox(
            ...
            child: Form(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.savings, color: AppColors.primary, size: 32),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(hintText: 'مثال: شراء مواد أولية، تجهيز المعرض...'),
              ),
              const SizedBox(height: AppSpacing.lg),
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(widget.existing != null ? 'حفظ التعديلات' : 'إضافة رأس المال'),
